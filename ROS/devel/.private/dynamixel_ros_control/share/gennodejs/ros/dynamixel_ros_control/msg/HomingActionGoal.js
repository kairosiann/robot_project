...
class HomingActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HomingGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HomingActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = HomingGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new HomingGoal()
    }
...
module.exports = HomingActionGoal;
