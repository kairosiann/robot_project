...
class HomingActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HomingFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new HomingActionFeedback(null);
    ...
    data.feedback = HomingFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HomingActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = HomingFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new HomingFeedback()
    }
...
module.exports = HomingActionFeedback;
